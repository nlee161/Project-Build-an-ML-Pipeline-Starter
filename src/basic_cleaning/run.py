...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "input artifact (sample.scv)",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Output artifact (cleaned_data.csv)",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "Type of output file (csv, exe, etc.)",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "Cleaned data (Outliers, skewness removed; datetime conversion)",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum Price to filter the price data by (10)",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Maximum Price to filter the price data by (350)",
        required = True
    )
